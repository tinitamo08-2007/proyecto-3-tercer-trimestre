...
FROM empleado e
LEFT JOIN actividad a ON a.id_empleado = e.id
...
-- -------------------------------------------------------------------
SELECT a.id, a.fecha, a.hora, a.tipo, a.descripcion,
...
JOIN animal an ON aa.id_animal = an.id
...
FROM empleado e
JOIN actividad a ON a.id_empleado = e.id
